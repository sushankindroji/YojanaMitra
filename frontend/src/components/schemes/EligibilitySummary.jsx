      ...
      <div className="mb-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">Based on your profile information</p>
          </div>
        </div>
        ...
        {eligibilityPercentage > 0 && (
          <div className="flex items-center gap-3 mt-4 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-200">
            ...
            <div className="flex-1">
              <p className="text-sm font-medium text-gray-900">Eligibility Match</p>
              <p className="text-xs text-gray-600">Your profile matches this scheme requirements</p>
            </div>
          </div>
        )}
      </div>
            ...
            <div>
              ...
              <ul className="space-y-1">
                {missingDocuments.map((doc, idx) => (
                  <li key={idx} className="flex items-center gap-2 text-sm text-orange-800">
